...
type RegKeputusanKeberatanPbb struct {
...
func (i RegPstPermohonan) SetKeputusanKeberatanPbb(nop PermohonanNOP) *RegKeputusanKeberatanPbb {
	return &RegKeputusanKeberatanPbb{
		PermohonanId:    &i.Id,
		KanwilId:        i.KanwilId,
		KppbbId:         i.KppbbId,
