...
type GeoJson struct {
	...
	RefName     *string `json:"RefName" gorm:"type:varchar(40)"`
	D_Nop       *string `json:"d_nop" gorm:"type:varchar(20)"`
	D_Luas      *string `json:"d_luas" gorm:"type:varchar(20)"`
	Nama        *string `json:"NAMA" gorm:"type:varchar(40)"`
	No          *string `json:"NO" gorm:"type:varchar(20)"`
	Alamat      *string `json:"ALAMAT" gorm:"type:varchar(250)"`
	Rt          *string `json:"RT" gorm:"type:varchar(20)"`
	Rw          *string `json:"RW" gorm:"type:varchar(20)"`
	Kelurahan   *string `json:"KELURAHAN" gorm:"type:varchar(30)"`
	Kecamatan   *string `json:"KECAMATAN" gorm:"type:varchar(30)"`
	Kota        *string `json:"KOTA" gorm:"type:varchar(30)"`
	...
	Fungsi_Bgn  *string `json:"FUNGSI_BGN" gorm:"type:varchar(40)"`
	Nama_Bgn    *string `json:"NAMA_BGN" gorm:"type:varchar(40)"`
	...
	Done        *string `json:"DONE" gorm:"type:varchar(1)"`
	Keterangan  *string `json:"KETERANGAN" gorm:"type:varchar(250)"`
...
type CreateDto struct {
	...
	Fungsi_Bgn  *string `json:"FUNGSI_BGN"`
	Nama_Bgn    *string `json:"NAMA_BGN"`
...
func (i GeoJson) GeoJsonPosition() [][][]float64 {
	...
	for i := range tempArrayString {
		temp := strings.TrimSpace(tempArrayString[i])
