...
func Create(input m.CreateDto, tx *gorm.DB) (any, error) {
	...
	if result := tx.Create(&data); result.Error != nil {
		return sh.SetError("request", "create-data", source, "failed", "gagal mengambil menyimpan data nop", data)
	}
...
func GetList(input m.FilterDto) (any, error) {
	...
	result := a.DB.
		...
		Find(&data)
	if result.Error != nil {
		return sh.SetError("request", "get-data-list", source, "failed", "gagal mengambil data nop", data)
	}
...
func Update(id int, input m.UpdateDto, tx *gorm.DB) (any, error) {
	...
	if result := tx.Save(&data); result.Error != nil {
		return sh.SetError("request", "update-data", source, "failed", "gagal mengambil menyimpan data nop", data)
	}
