...
func GetReportTunggakan(re m.RequestDto) (*excelize.File, error) {
	datas := new([]m.Sppt)
	return generatePenagihanTunggakanToXLSX(*datas)
}

func generatePenagihanTunggakanToXLSX(datas []m.Sppt) (*excelize.File, error) {
	var (
		start     int = 8
