...
import (
	...
	mfb "github.com/bapenda-kota-malang/apin-backend/internal/models/regfasilitasbangunan"
	m "github.com/bapenda-kota-malang/apin-backend/internal/models/regobjekpajakbangunan"
	sfb "github.com/bapenda-kota-malang/apin-backend/internal/services/regfasilitasbangunan"
...
func Create(input m.CreateDto) (any, error) {
	...
	if input.RegFasilitasBangunans != nil {
		// copy data fasilitas bangunan
		if err := sc.Copy(&dataFasilitasBangunan, input.RegFasilitasBangunans); err != nil {
			return sh.SetError("request", "create-data", source, "failed", "gagal mengambil data payload reg fasilitas bangunan", input.RegFasilitasBangunans)
		}
