...
import (
	...
	m "github.com/bapenda-kota-malang/apin-backend/internal/models/dbkbfasum/nondep"
	t "github.com/bapenda-kota-malang/apin-backend/pkg/apicore/types"
)

const source = "dpkbfasumnondep"

func Create(input m.CreateDto, tx *gorm.DB) (any, error) {
	if tx == nil {
		tx = a.DB
	}
	var data m.DbkbFasumNonDep

	condition := m.DbkbFasumNonDep{
	...
	if err != nil {
		return sh.SetError("request", "create-data", source, "failed", "gagal mengambil menyimpan data dpkbfasumnondep: "+err.Error(), data)
	}
