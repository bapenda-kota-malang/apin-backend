...
import (
	...
	m "github.com/bapenda-kota-malang/apin-backend/internal/models/dbkbfasum/depjpbklsbintang"
	t "github.com/bapenda-kota-malang/apin-backend/pkg/apicore/types"
)

const source = "dbkbfasumdepjpbklsbintang"

func Create(input m.CreateDto, tx *gorm.DB) (any, error) {
	if tx == nil {
		tx = a.DB
	}
	var data m.DbkbFasumDepJpbKlsBintang

	condition := m.DbkbFasumDepJpbKlsBintang{
...
func GetList(input m.FilterDto) (any, error) {
	...
	result := a.DB.
		Model(&m.DbkbFasumDepJpbKlsBintang{}).
