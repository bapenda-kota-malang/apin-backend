...
import (
	...
	s "github.com/bapenda-kota-malang/apin-backend/internal/services/dbkbmezanin"
)
...
func DownloadExcelList(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=list_dbkb_mezzanin.xlsx")
