DROP FUNCTION IF EXISTS "public"."penilaian_jpb12"("provinsi_kode" bpchar, "daerah_kode" bpchar, "kecamatan_kode" bpchar, "kelurahan_kode" bpchar, "blok_kode" bpchar, "nourut" bpchar, "jenisop" bpchar, "nobangunan" int8, "tahun" varchar);
CREATE OR REPLACE FUNCTION "public"."penilaian_jpb12"("provinsi_kode" bpchar, "daerah_kode" bpchar, "kecamatan_kode" bpchar, "kelurahan_kode" bpchar, "blok_kode" bpchar, "nourut" bpchar, "jenisop" bpchar, "nobangunan" int8, "tahun" varchar)
  RETURNS "pg_catalog"."numeric" AS $BODY$
declare
  nilai_jpb numeric := 0;
  nilai_jpb12 numeric := 0;
...
begin
  ...
  BEGIN
    SELECT "NilaiDbkbJpb12"
    INTO nilai_komponen_utama
    FROM "DbkbJpb12"
    WHERE "Provinsi_Kode" = Provinsi_Kode
      AND "Daerah_Kode" = Daerah_Kode
      AND "TahunDbkbJpb12" = Tahun
      AND "TipeDbkbJpb12" = type_jpb12;
  ...
  BEGIN
	  ...
	  INTO luas_bng, tahun_dibangun, tahun_renovasi, kondisi_bng, jml_lantai_bng
  ...
  -- Total nilai JPB 12
  nilai_jpb12 := nilai_setelah_susut + nilai_fasilitas_tdk_susut;
  nilai_jpb := nilai_jpb12;
